...
from redash_stmo.handlers import extract_table_names
...
class StmoQueryResultResource(QueryResultResource):
    ...
    def get(self, query_id=None, query_result_id=None, filetype='json'):
                ...
                for table_name in extract_table_names.extract_tables(query_result.query_text):
                    ...
                    if table_name.startswith("query_"):
                        try:
                            ...
                            continue
                        upstream_q = models.Query.query.filter(models.Query.id == qid).first()
        ...
        return QueryResultResource.get(self, query_id, query_result_id, filetype)

def handler_queryresults(app):

    # remove the original resource
    del app.view_functions['query_result']
    add_resource(app, StmoQueryResultResource,
